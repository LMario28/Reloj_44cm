...
COLOR_RELOJ_MINUTOS_INACTIVOS_FASCINACION=(0,2,0)
...
color_reloj_hora_activa=tuple(c for c in COLOR_RELOJ_HORA_ACTIVA_FASCINACION)
color_reloj_hora_activa = tuple(map(round,color_reloj_hora_activa))
color_reloj_minuto_activo=tuple(c for c in COLOR_RELOJ_MINUTO_ACTIVO_FASCINACION)
color_reloj_minuto_activo = tuple(map(round,color_reloj_minuto_activo))
color_reloj_segundo_activo=tuple(c for c in COLOR_RELOJ_SEGUNDO_ACTIVO_FASCINACION)
